...
namespace EnhancedScrollerDemos.ExpandingCells
{
    ...
    public class CellView : EnhancedScrollerCellView
    {
        ...
        public void SetData(DataPista data, int dataIndex, float collapsedSize, float expandedSize, Action<int, int> initializeTween, Action<int, int, float, float> updateTween, Action<int, int> endTween)
        {
            ...
            if (data.imageOptional != null)
            {
                image.sprite = data.imageOptional;
                image.SetNativeSize();
                image.enabled = data.isExpanded;
            }
            else
            {
                image.sprite = null;
